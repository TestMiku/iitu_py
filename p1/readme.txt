...
3. У каждого разраба есть своя ветка (p1, np, mp, gp)  в котором есть urls.py. по ссылке "host:post/np/" будут попадаться в вашу ветку. Все ссылки на ваши приложении прописывать там
